                ...
                <table class="table table-hover table-striped table-responsive" id="divTable">
                    ...
                    <tbody>
                        ...
                        <tr v-for="(r, index) in registros">
                            ...
                            <td>{{ r.numero_documento_titular }}</td>
                            <td>{{ r.parentesco_titular }}</td>
                            <td>
                                ...
                                <span v-else-if="r.estado.descripcion == 'AMPLIACIÓN'"
                                    class="text-primary">{{ r.estado.descripcion }}</span>
                            </td>
                            <td width="15%" scope="row">
                                <button type="button" class="btn btn-info" data-bs-toggle="modal"
                                    data-bs-target="#exampleModal" title="Búsqueda detallada"><span
                                        class="material-icons-outlined">search</span></button>
                                <button type="button" v-on:click="verInfo(index)" class="btn btn-danger"
                                    data-bs-toggle="modal" data-bs-target="#modalEliminar"><span
                                        class="material-icons-outlined" title="Baja Afiliado">delete</span></button>
                                <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                    data-bs-target="#exampleModal" title="Ampliación de baja"><span
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container text-left">
                            <div class="row">
                                <div class="col-sm-3 text-start     ">ENTIDAD:</div>
...
export default {
    name: 'BeneficiariosTitular',
    data() {
        return {
            plural: 'Afiliados Beneficiarios',
            singular: 'Afilidao',
            registros: [],
            registro: {},
    ...
    methods: {
        ...
        listarTituares() {
            ...
            let url = "https://bdpa.asuss.gob.bo/api/v1/beneficiario/ente-gestor";
            try {
                axios.get(url, {
